...
?>
<?php
class MagenThemes_MTFastion_Adminhtml_RestoreController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')
            ->isAllowed('magenthemes/mtfastion/restore');
    }

    protected function _initAction()
    {
        $this->loadLayout()
            ->_setActiveMenu('magenthemes/mtfastion/restore')
    ...
    public function indexAction()
    {
        ...
        $this->_title($this->__('MagenThemes'))
            ->_title($this->__('MTFastion'))
            ->_title($this->__('Restore Defaults'));
        $this->_addContent($this->getLayout()->createBlock('mtfastion/adminhtml_restore_edit'));
        $this->renderLayout();
    }
    ...
    public function restoreAction()
    {
	    ...
	    try {
            ...
            $defaults->loadFile(Mage::getBaseDir().'/app/code/local/MagenThemes/MTFastion/etc/config.xml');
            $this->_restoreSettings($defaults->getNode('default/mtfastion_design')->children(), 'mtfastion_design');
            Mage::getSingleton('adminhtml/session')->addSuccess(
                Mage::helper('adminhtml')->__('Default Settings for MTFastion Design Theme has been restored.'));
        }
        catch (Exception $e) {
