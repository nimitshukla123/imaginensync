...
class MagenThemes_Dataporter_Block_Adminhtml_Cfgporter_Import_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
	/**
	 * Preparing form
	 *
	...
	protected function _prepareForm()
	{
		...
		$fieldStores = $fieldset->addField('store_id', 'select', array(
			...
			'required'	=> true,
			'values'	=> Mage::getSingleton('mtfastion/config_scope')->getScopeSelectOptions(true, true),
			'value'		=> 'default@0',
		));
